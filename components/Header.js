    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-transparent">
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-0 items-center justify-center flex z-0 w-full h-screen bg-gray-900">
          <ul className="flex flex-col items-center py-4 space-y-4 text-white font-light tracking-wide text-sm">
            <button 
            ...
            <li><Link href="/" className="hover:text-gray-300" onClick={() => setIsMenuOpen(false)}>ANA SAYFA</Link></li>
            <li><Link href="/about" className="hover:text-gray-300" onClick={() => setIsMenuOpen(false)}>HAKKIMDA</Link></li>
            <li><Link href="/portfolio" className="hover:text-gray-300" onClick={() => setIsMenuOpen(false)}>PORTFOLYO</Link></li>
            <li><Link href="/contact" className="hover:text-gray-300" onClick={() => setIsMenuOpen(false)}>İLETİŞİM</Link></li>
          </ul>
        </div>
      )}
    </header>
